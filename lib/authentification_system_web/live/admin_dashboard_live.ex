defmodule AuthentificationSystemWeb.AdminDashboardLive do
  ...
  def mount(_params, _session, socket) do
    ...
    # For recent activity, show the 5 most recently registered users
    recent_activity =
      users
      ...
      |> Enum.map(fn user ->
        %{
          ...
          user: user.email,
          time: time_ago_in_words(user.inserted_at)
        }
      end)
    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-600 mt-1">Welcome back! Here's what's happening with your system.</p>
        </div>
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-sm text-gray-500">
                      <%= String.replace(activity.type, "_", " ") |> String.capitalize() %> • <%= activity.time %>
                    </p>
                  </div>
                </div>
              <% end %>
            ...
            <div class="space-y-3">
              ...
              <button class="w-full text-left p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                <div class="flex items-center">
                  ...
                  <span class="text-sm font-medium text-gray-900">Create Backup</span>
                </div>
              </button>
            </div>
          </div>
